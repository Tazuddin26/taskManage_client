      ...
      <div className="lg:flex gap-5 w-full">
        ...
        <div className="w-full gap-4 space-y-4 ">
          ...
          <div className="w-full mt-10">
            <UseSelectOption options={statusOption} label="Change Status" />
          </div>
        </div>
      </div>
      <div className=" mt-20 my-4 flex justify-end gap-5 lg:p-6">
        <button className="btn px-6 border-none bg-[#FF4C2426] hover:bg-[#FF4C2446] text-[#FF4C24]">
          Delete Task
        </button>
        <button className="btn px-10 bg-[#60E5AE] ">Submit</button>
      </div>
    </div>
  );
};
